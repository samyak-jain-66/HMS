...
<div class="d-flex" id="wrapper">
      ...
      <div id="page-content-wrapper">
          <div class="container-fluid">
            <br><center>
            <p style="font-family: 'Raleway', sans-serif;font-size:20px;color:white;">Welcome Admin. Here is the status of various activities.</p></center>
            <br><br>
            <div class='form-row' style="margin-left:28px;">
                  <div class="form-group col-lg-4">
                 <div class="col-xm-3" style="opacity:0.7">
                  <div class="card" style="width: 18rem;">
                    <div class="card-body" style="">
                      ...
                      <span style="font-size:50px;float:right;height:10px;font-family: 'Raleway', sans-serif;"><?php echo $totalr?></span><br><br><br>
                      <p class="card-text" style="float:right;font-family: 'Raleway', sans-serif;">Total Rooms.</p>
                    </div>
                  </div>
                 </div>
                </div>
                 ...
                 <div class="col-xm-3" style="opacity:0.7">
                  <div class="card" style="width: 18rem;">
                    <div class="card-body">
                      ...
                      <span style="font-size:50px;float:right;height:10px;font-family: 'Raleway', sans-serif;"><?php echo $totala?></span><br><br><br>
                      <p class="card-text" style="float:right;font-family: 'Raleway', sans-serif;">Available Rooms.</p>
